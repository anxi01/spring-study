...
class AuthorRepositoryTest {
    ...
    void manyToManyTest() {
        ...
        // BookAndAuthor 중간 테이블을 만들었기 때문에 book3에 대한 공동 저자를 따로 저장
        ...
        bookRepository.findAll().get(2).getBookAndAuthors().forEach(o -> System.out.println(o.getAuthor() + " " + o.getBook()));
        authorRepository.findAll().get(0).getBookAndAuthors().forEach(o -> System.out.println(o.getAuthor() + " " + o.getBook()));
